...
- **Secure account UX:** browser/password-manager friendly sign-in fields, wider horizontal auth layouts, and Cognito email-based password recovery for AWS Live deployments.
